...
WORKS = {
  ...
  "61724" => {
    id: "sufi.rumi.mesnevi_book_1_redhouse_gutenberg",
    title: "The Mesnevi",
    alternate_titles: ["Masnavi", "Mesnevi-yi Sherif", "The Mesnevi of Rumi, Book I"],
    text_status: "selected",
    tradition: "sufi",
    culture: "persian_sufi_mevlevi_later_translation",
    region: "iran_anatolia",
    source_language: "Persian",
    text_language: "English",
    date_range: "13th-century Persian Sufi source text; 1881 public-domain English translation of Book I",
    source_type: "text",
    source_id: "source.project_gutenberg.61724",
    edition: "Project Gutenberg plain-text eBook #61724",
    translator: "Sir James W. Redhouse",
    editor: nil,
    publication_year: 1881,
    publisher: "Project Gutenberg",
    source_url: "https://www.gutenberg.org/ebooks/61724",
    raw_path: "imports/raw/project-gutenberg/61724-mesnevi-rumi.txt",
    converted_path: "imports/converted/project-gutenberg/61724-mesnevi-rumi.md",
    canonical_path: "texts/public-domain/sufi/project-gutenberg/mesnevi-book-1-redhouse.md",
    manifest_path: "manifests/project-gutenberg/61724-mesnevi-book-1-redhouse.yml",
    extraction_dir: "extractions/sufi/project-gutenberg/mesnevi-book-1",
    tags: %w[rumi masnavi mesnevi mevlevi persian_sufi divine_love parable reed_flute],
    motifs: %w[mystical_quest divine_beloved annihilation_union wisdom sacred_song initiation],
    figures: ["Jalal al-Din Rumi", "Shams-i Tabriz", "Beloved", "seeker"],
    tradition_cluster: "islamic_persian_sufi"
  },
  "58977" => {
    id: "sufi.al_ghazzali.confessions_field_gutenberg",
    title: "The Confessions of Al Ghazzali",
    alternate_titles: ["Al-Munqidh min al-Dalal", "Deliverance from Error"],
    text_status: "complete",
    tradition: "sufi",
    culture: "persian_islamic_sufi_later_translation",
    region: "iran_west_asia",
    source_language: "Arabic",
    text_language: "English",
    date_range: "late 11th to early 12th century source text; 1909 public-domain English translation",
    source_type: "text",
    source_id: "source.project_gutenberg.58977",
    edition: "Project Gutenberg plain-text eBook #58977",
    translator: "Claud Field",
    editor: "L. Cranmer-Byng and S. A. Kapadia",
    publication_year: 1909,
    publisher: "Project Gutenberg",
    source_url: "https://www.gutenberg.org/ebooks/58977",
    raw_path: "imports/raw/project-gutenberg/58977-confessions-al-ghazzali.txt",
    converted_path: "imports/converted/project-gutenberg/58977-confessions-al-ghazzali.md",
    canonical_path: "texts/public-domain/sufi/project-gutenberg/confessions-al-ghazzali-field.md",
    manifest_path: "manifests/project-gutenberg/58977-confessions-al-ghazzali.yml",
    extraction_dir: "extractions/sufi/project-gutenberg/confessions-al-ghazzali",
    tags: %w[ghazzali ghazali sufism philosophy certainty skepticism illumination asceticism],
    motifs: %w[mystical_quest wisdom initiation self_knowledge revelation renunciation],
    figures: ["Al Ghazzali", "seekers after truth", "Sufis"],
    tradition_cluster: "islamic_persian_sufi"
  },
  "24314" => {
    id: "sufi.mystics_and_saints_of_islam.field_gutenberg",
    title: "Mystics and Saints of Islam",
    alternate_titles: ["Mystics and Saints of Islam"],
    text_status: "complete",
    tradition: "sufi",
    culture: "islamic_sufi_biographical_collection",
    region: "west_asia_iran_north_africa_south_asia",
    source_language: "English",
    text_language: "English",
    date_range: "1910 public-domain English study with translated Sufi biographical material",
    source_type: "text",
    source_id: "source.project_gutenberg.24314",
    edition: "Project Gutenberg plain-text eBook #24314",
    translator: "Claud Field",
    editor: nil,
    publication_year: 1910,
    publisher: "Project Gutenberg",
    source_url: "https://www.gutenberg.org/ebooks/24314",
    raw_path: "imports/raw/project-gutenberg/24314-mystics-and-saints-of-islam.txt",
    converted_path: "imports/converted/project-gutenberg/24314-mystics-and-saints-of-islam.md",
    canonical_path: "texts/public-domain/sufi/project-gutenberg/mystics-and-saints-of-islam-field.md",
    manifest_path: "manifests/project-gutenberg/24314-mystics-and-saints-of-islam.yml",
    extraction_dir: "extractions/sufi/project-gutenberg/mystics-and-saints-of-islam",
    tags: %w[sufism saints rabia hallaj attar rumi ghazzali divine_love asceticism],
    motifs: %w[mystical_quest divine_beloved annihilation_union wisdom teacher_disciple initiation],
    figures: ["Rabia", "Mansur Hallaj", "Bayazid Bastami", "Fariduddin Attar", "Jalaluddin Rumi", "Al Ghazzali"],
    tradition_cluster: "islamic_sufi"
  },
  "67388" => {
    id: "sufi.mystics_of_islam.nicholson_gutenberg",
    title: "The Mystics of Islam",
    alternate_titles: ["The Mystics of Islam"],
    text_status: "complete",
    tradition: "sufi",
    culture: "islamic_sufi_scholarship",
    region: "west_asia_iran_north_africa_south_asia",
    source_language: "English",
    text_language: "English",
    date_range: "1914 public-domain English study of Sufi doctrine and practice",
    source_type: "text",
    source_id: "source.project_gutenberg.67388",
    edition: "Project Gutenberg plain-text eBook #67388",
    translator: "",
    editor: "Reynold A. Nicholson",
    publication_year: 1914,
    publisher: "Project Gutenberg",
    source_url: "https://www.gutenberg.org/ebooks/67388",
    raw_path: "imports/raw/project-gutenberg/67388-mystics-of-islam-nicholson.txt",
    converted_path: "imports/converted/project-gutenberg/67388-mystics-of-islam-nicholson.md",
    canonical_path: "texts/public-domain/sufi/project-gutenberg/mystics-of-islam-nicholson.md",
    manifest_path: "manifests/project-gutenberg/67388-mystics-of-islam-nicholson.yml",
    extraction_dir: "extractions/sufi/project-gutenberg/mystics-of-islam",
    tags: %w[sufism path gnosis ecstasy divine_love saints miracles unitive_state],
    motifs: %w[mystical_quest divine_beloved annihilation_union wisdom initiation ascent],
    figures: ["Sufi path", "saints", "lover", "Beloved"],
    tradition_cluster: "islamic_sufi"
  },
  "5186" => {
