---
id: egyptian.tales_first_series.petrie_gutenberg
title: 'Egyptian Tales, Translated from the Papyri: First Series, IVth to XIIth Dynasty'
alternate_titles:
- Westcar Papyrus tales
- Tales of the Magicians
- Sanehat
text_status: complete
tradition: egyptian
culture: middle_kingdom_egyptian_narrative_later_translation
region: nile_valley
source_language: Middle Egyptian
text_language: English
date_range: tales c. 2000-1700 BCE (papyri incl. Westcar); Petrie edition published
  1895
source_type: text
provenance:
  source_id: source.project_gutenberg.7386
  edition: 'Project Gutenberg plain-text eBook #7386 (Methuen 1895 edition, edited
    by W. M. Flinders Petrie, translations by F. Ll. Griffith)'
  translator: F. Ll. Griffith
  editor: W. M. Flinders Petrie
  publication_year: 1895
  publisher: Project Gutenberg
  source_url: https://www.gutenberg.org/ebooks/7386
...
rights:
  ...
  full_text: allowed
  notes: Project Gutenberg catalog records public-domain status in the USA; use outside
    the USA requires jurisdiction-specific review.
trademark:
  status: present
  marks:
  - Project Gutenberg
...
tags:
- westcar_papyrus
- tales_of_the_magicians
- sinuhe
- shipwrecked_sailor
- egyptian_magic
motifs:
- magician_restores_severed_head
- prophecy_of_royal_birth
- shipwreck_island_serpent_god
- exile_and_return
figures:
- Khufu
- Dedi
