---
id: greek.apollodorus.library.frazer_archive_v1
title: The Library, Volume I (Apollodorus), with an English Translation by James George
  Frazer
alternate_titles:
- Bibliotheca
- Apollodorus Library
...
tradition: greek
culture: ancient_greek_mythography_later_translation
region: aegean_mediterranean
source_language: Ancient Greek
text_language: English
date_range: 1st-2nd century CE mythographic handbook; 1921 public-domain translation
source_type: text
provenance:
  source_id: source.internet_archive.librarywithengli01apoluoft
  edition: Apollodorus, The Library, Vol. I, trans. J. G. Frazer (Loeb Classical Library,
    Heinemann/Putnam, 1921); Internet Archive scan with OCR plain text
  translator: James George Frazer
  editor: ''
  publication_year: 1921
  publisher: William Heinemann / G. P. Putnam's Sons
  source_url: https://archive.org/details/librarywithengli01apoluoft
...
rights:
  ...
  full_text: allowed
  notes: Published 1921, US public domain. Loeb edition; OCR plain text includes Greek
    facing pages that render as noise, but the English translation and Frazer's notes
    extract cleanly. Volume II lacks a plain-text derive on Internet Archive and was
    omitted.
trademark:
  status: present
  marks:
