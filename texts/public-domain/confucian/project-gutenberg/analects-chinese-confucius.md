---
id: chinese.confucius.analects_chinese_gutenberg
title: 論語
alternate_titles:
- The Analects
- Lunyu
...
tradition: confucian
culture: classical_chinese_confucian_original_language
region: china
source_language: Classical Chinese
text_language: Chinese
date_range: compiled c. 475-221 BCE from sayings of Confucius (551-479 BCE)
source_type: text
provenance:
  source_id: source.project_gutenberg.23839
  edition: 'Project Gutenberg plain-text eBook #23839, traditional-character Chinese
    text of the Analects (20 books, numbered sections)'
  translator: ''
  editor: ''
  publication_year: 2007
  publisher: Project Gutenberg
  source_url: https://www.gutenberg.org/ebooks/23839
...
rights:
  ...
  notes: 'original-language extraction program: translator-effect control. Ancient
    Chinese text, public domain; clean Unicode traditional characters verified. Pairs
    with Legge''s Chinese Classics and SBE volumes (Shu King, Shih King, Li Ki) already
    ingested in English.'
trademark:
  status: present
  marks:
...
29. 子曰：「可與共學，未可與適道；可與適道，未可與立；可與立，未可與權。」 30. 「唐棣之華，偏其反而，豈不爾思？室是遠而。」子曰：「未之思也，未何遠之有？」
