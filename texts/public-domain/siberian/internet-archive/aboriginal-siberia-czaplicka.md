---
id: siberian.aboriginal_siberia.czaplicka_archive
title: Aboriginal Siberia - A Study in Social Anthropology
alternate_titles:
- Aboriginal Siberia
- Aboriginal Siberia - Czaplicka
text_status: complete
tradition: siberian
culture: siberian_indigenous_religion_and_shamanism
region: siberia
source_language: English
text_language: English
date_range: study of Siberian indigenous social organization, religion, and shamanism;
  1914 public-domain work
source_type: text
provenance:
  source_id: source.internet_archive.aboriginalsiberi00czap
  edition: 'M. A. Czaplicka, Aboriginal Siberia: A Study in Social Anthropology (Clarendon
    Press, Oxford, 1914); Internet Archive scan with OCR plain text'
  translator: ''
  editor: ''
  publication_year: 1914
  publisher: Clarendon Press
  source_url: https://archive.org/details/aboriginalsiberi00czap
...
rights:
  ...
  full_text: allowed
  notes: Published 1914 (pre-1930), US public domain. Czaplicka's synthesis of Siberian
    ethnography, esp. shamanism, drawing together many field sources with quoted verbatim
    accounts; author-synthesis prose with embedded primary excerpts. OCR of a scan;
    expect OCR noise.
trademark:
  status: present
  marks:
