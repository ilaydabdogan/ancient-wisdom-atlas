---
id: buddhist.dhammapada.muller_gutenberg
title: Dhammapada, a Collection of Verses; Being One of the Canonical Books of the
  Buddhists
alternate_titles:
- The Dhammapada
- Dhammapada
...
tradition: buddhist
culture: early_buddhist_canon_later_translation
region: south_asia
source_language: Pali
text_language: English
date_range: early Buddhist canonical verse collection; 1881 public-domain English
  translation (Sacred Books of the East, Vol. 10, Part I)
source_type: text
provenance:
  source_id: source.project_gutenberg.2017
  edition: 'Project Gutenberg plain-text eBook #2017; F. Max Müller, The Dhammapada
    (Sacred Books of the East, Vol. 10, Part I, 1881)'
...
rights:
  ...
  full_text: allowed
  notes: Project Gutenberg catalog records public-domain status in the USA; Müller's
    1881 SBE translation is long out of copyright. Distinct standalone Dhammapada
    not separately canonicalized in the corpus (only the Sutta-Nipata portion of SBE
    10 is present).
trademark:
  status: present
  marks:
