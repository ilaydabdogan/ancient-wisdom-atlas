---
id: shinto.nihongi.volume_1.aston_archive
title: 'Nihongi: Chronicles of Japan from the Earliest Times to A.D. 697, Volume 1'
alternate_titles:
- Nihongi
- Nihon Shoki
...
source_type: text
provenance:
  source_id: source.internet_archive.nihongi1asto
  ...
  source_url: https://archive.org/details/nihongi1asto
...
rights:
  ...
  full_text: allowed
  notes: Published 1896, US public domain. OCR of first pages is noisy (cover art);
    body text is clean enough for conversion with a trimming pass.
trademark:
  status: present
  marks:
  - Project Gutenberg
