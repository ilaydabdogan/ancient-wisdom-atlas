---
id: latin.ovid.fasti_latin_gutenberg
title: Fasti
alternate_titles:
- Ovid's Fasti (Latin text with Keightley's introduction and notes)
- Fastorum Libri VI
text_status: complete
tradition: roman
culture: augustan_roman_religious_calendar_original_language
region: italy_mediterranean
source_language: Latin
text_language: Latin
date_range: composed c. 8 CE; Keightley school edition mid-19th century
source_type: text
provenance:
  source_id: source.project_gutenberg.8738
  edition: 'Project Gutenberg plain-text eBook #8738, Latin text of the six books
    of the Fasti with Thomas Keightley''s English introduction and notes'
  translator: ''
  editor: Thomas Keightley
  publication_year: 1848
  publisher: Project Gutenberg
  source_url: https://www.gutenberg.org/ebooks/8738
...
rights:
  ...
  full_text: allowed
  notes: 'original-language extraction program: translator-effect control. Latin verse
    text is original-language; surrounding apparatus (preface, notes) is 19th-century
    English - extraction should target the Latin books. Queued in place of Metamorphoses:
    PG has NO Latin Metamorphoses (only English translations #21765/#26073/#28621),
    and archive.org Latin scans are blackletter-era or Loeb mixed-language; Fasti
    is Ovid''s most ritual-dense work regardless.'
trademark:
  status: present
  marks:
  - Project Gutenberg
