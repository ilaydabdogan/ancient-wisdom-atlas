---
id: korean.korean_tales.allen_archive
title: Korean Tales
alternate_titles:
- Korean Tales - Allen
- Korean Tales - Stories from Korea
...
date_range: Korean folk and popular tales; 1889 public-domain English collection
source_type: text
provenance:
  source_id: source.internet_archive.koreantalesbeing00alle
  edition: 'Horace N. Allen, Korean Tales: Being a Collection of Stories Translated
    from the Korean Folk Lore (G. P. Putnam''s Sons, New York, 1889); Internet Archive
    scan with OCR plain text'
  translator: Horace Newton Allen
  editor: ''
  publication_year: 1889
  publisher: G. P. Putnam's Sons
  source_url: https://archive.org/details/koreantalesbeing00alle
...
rights:
  ...
  full_text: allowed
  notes: 'Published 1889 (pre-1930), US public domain. Verbatim: Allen''s English
    retellings of Korean folk stories (incl. the Rabbit and other tales) with an introductory
    sketch. OCR of a scan; expect OCR noise.'
trademark:
  status: present
  marks:
  - Project Gutenberg
