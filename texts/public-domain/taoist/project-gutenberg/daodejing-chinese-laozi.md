---
id: chinese.laozi.daodejing_chinese_gutenberg
title: 道德經
alternate_titles:
- Daodejing
- Tao Te Ching
...
tradition: taoist
culture: classical_chinese_taoist_original_language
region: china
source_language: Classical Chinese
text_language: Chinese
date_range: composed c. 4th century BCE (traditional attribution to Laozi)
source_type: text
provenance:
  source_id: source.project_gutenberg.7337
  edition: 'Project Gutenberg plain-text eBook #7337, traditional-character Chinese
    text of the Daodejing (81 chapters)'
  translator: ''
  editor: ''
  publication_year: 2005
  publisher: Project Gutenberg
  source_url: https://www.gutenberg.org/ebooks/7337
...
rights:
  ...
  notes: 'original-language extraction program: translator-effect control. Ancient
    Chinese text, public domain; clean Unicode traditional characters verified. Original-language
    control for Legge''s SBE English Taoist/Confucian translations already in the
    corpus.'
trademark:
  status: present
  marks:
