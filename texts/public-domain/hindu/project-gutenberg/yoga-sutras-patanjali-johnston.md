---
id: hindu.yoga_sutras.johnston_gutenberg
...
date_range: sutras c. 200 BCE-400 CE; Johnston interpretive translation 1912
source_type: text
provenance:
  source_id: source.project_gutenberg.2526
  edition: 'Project Gutenberg plain-text eBook #2526'
...
rights:
  ...
  full_text: allowed
  notes: Project Gutenberg records US public-domain status. Johnston was a Theosophist;
    his commentary is interpretive and should be kept distinct from the sutra text
    during extraction.
trademark:
  status: present
  marks:
