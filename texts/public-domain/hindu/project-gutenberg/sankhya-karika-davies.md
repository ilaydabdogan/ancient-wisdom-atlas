---
id: hindu.samkhya_karika.davies_archive
title: 'Hindu Philosophy: The Sankhya Karika of Iswara Krishna'
alternate_titles:
- Samkhya Karika
- Sankhya Karika
text_status: complete
tradition: hindu
culture: classical_indian_philosophy_later_translation
region: south_asia
source_language: Sanskrit
text_language: English
date_range: karikas c. 350 CE; Davies English exposition and translation 1881
source_type: text
provenance:
  source_id: source.internet_archive.11542006bsb
  edition: Internet Archive full-text OCR (_djvu.txt) of Trubner's Oriental Series
    1881 edition (Bavarian State Library scan)
  translator: John Davies
  editor: ''
  publication_year: 1881
  publisher: Internet Archive
  source_url: https://archive.org/details/11542006bsb
...
rights:
  ...
  full_text: allowed
  notes: Published 1881, US public domain. Volume interleaves karika verses with Davies's
    exposition; extraction should separate verse text from commentary.
trademark:
  status: present
  marks:
  - Project Gutenberg
...
- dualism
motifs:
- spirit_matter_duality
- enumeration_of_principles
- liberation
...
I wis to present to my readers the philosophy of Kapila
as it has been set forth by his Indian exponent, Iswara
...
this respect the human intellect has gone over the same
ground that it occupied more than two thousand y:
...
OF KAPILA, THE AUTHOR OF THE SANKHYA SYSTEM :
...
ON THE MEANING OF “gat” AND “ asaT” f . F


Note C.
ON THE CONNECTION OF THE SANKHYA SYSTEM WITH THE
PHILOSOPHY OF SPINOZA 3 P 5 ; :
Notr D.
...
THE Hindi schools of philosophy are usually classed in
the following order :—

1. The N yaya, founded by Gautama. 4

2. The Vaisgeshika, by Kanada.
...
6. The Vedanta, by Badarayana, sometimes called
Vyasa, or Veda Vyasa.
...
to the Vedas. It differs from the Pirva Mimansa chiefly
...
forms of the one eternal Essence (7d &). The basis
...
3 Mimansa, both divisions of it being devoted to
ort and illustration of the Vedas.


of the pure Sankhya doctrine of Kapila. —
...
1 In the Padma Purana he is said to have dwelt in the village of
Indraprastha (F. Hall, Introduction to 8. Sara, p. 20).
...
1 Sankara says, however, that it mentary on the Brahma Sitras, ii.
was another Kapila, named also 1, 1; Sans. T., iii. 190).
Vasudeva [a name of Krishna], who 2 Sanskrit Literature, p. 83.
...
and also calculation, reasoning. In the Mahabharata it
...
4. The Sdnkhya-Karikaé (Exposition of the Sankhya),
...
It consists of seventy-two distichs or Slokas, each
...
It is written in the Arya or Gatha metre.
...
interpreted the Hindu system, or this exposition of it,
...
ps EN eo a ne 7S Jr udhcsaltaedn sands: .3
...
first line, apaghatake, which is found
in the S. Tatwa Kaumudi and S.
...
2. The natural and extrinsic (ddhibhautika).
3. The divine or supernatural (ddhidaivika).
...
_ of an absolute self-existence, cannot be gained by any
_ religious rites. It is obtained by knowledge, and yet not
by every kind of knowledge: it can only be gained by a
knowledge of philosophy (which Kapila expounds), and


1 “By gruti is meant the Veda, exposition), for from them all law
and by smyiti (tradition, lit. remem- or duty (dharma) has proceeded”
brance), the institutes of law(dharma- (Manu, ii. 10).
sastra). These are not to be op- ? Gaudapada’s Commentary on
pugned by heterodox arguments(con- this distich.
trary to the Mimansa or Vedantist 3 Sank. Prav., i. 83, 843; vi. 58.
...
or primal matter, called Prakriti or Pradhina (Avyakta) ;1
...
3. “Nature (Prakritr), the root (of material
...
produced. Sixteen are productions’ (only). Soul
...
From Prakriti proceed: (1.) Intellect (Aahat or Buddhi),
...
“Ald 6 Thy Tod yeyovoros dpaTod
kat mdyTws atoOnrod pnrépa Kat
urodoxny pare yiv unre dépa pjre
tip, pyre dws Neywev, pare boa ex


Torey pyre €& &v radra yéyover,
ad’ dvdparov eldos Te Kal dmopdov
mavoexés”” (Timeeus, 24).

2 Properly “modifications” (vih-
Gra). ‘They are only developments
from a primary form, and have no
developing power.

3 Modern science, like the system
of Kapila, makes intellect a mere
...
Egoism (Ahankdra); a consequence resembling that of
Descartes: “ Cogito, ergo sum.” Self-consciousness is not,
...
Clifford assumed as the original ground of all being, we.,
of all formal being; a synthesis of mind and grosser
matter in which consciousness was produced, by which


1 Comp. Hegel on Thought (Das_ one another, but one world of nature,
Denken), in connection with the Ab- whereof human consciousness is an
solute: “Es ist das Licht, welches evolution” (Maudsley, p. 57). A
leuchtet ;-aber eben keinen andern dogmatic assertion, but only of a
Inhalt hat, als eben dasLicht” (Phil. theory, as yet unproved, though
der Rel., i. 117). offered at first more than 2000 years

2 “There are not two worlds, a ago.
world of nature and a world of human 3 Metaphysics, i. 193.
...
From Ahankara or Consciousness proceed the five
subtle elements (¢anmdtra) which are the primary forms or
essences of gross material things, z.¢., of all formal life.
...
Both Consciousness and all existing external
...
In one re-
2 “Bedenkt man dass diese Natur
...
blos in dem Radicalvermégen aller
...
there is still a dualism. The soul is different in kind
...
names of sownd, tangibleness or touch, odour, visibility or
form, and taste.

From these primary essences proceed the five gross
elements (mahabhita). These are: (1.) ether (4kaSa), from
the subtle element called sownd ; this fills all space and
envelops all things; (2.) air (vayu), from the element
...
other does not exist, and there is it (thought).”
...
being, laid down in the Sankhya system. They are the
...
(siddht) of what is to be determined is by proof.” ?
...
Inference (anwmdna) is the process of reasoning. The
conclusion that is drawn from it is anwmitt (Tarka
...
priort, from cause to effect; a posteriori, from effect to
...
in apposition with anumanat. The
...
word sémdanya is not used by Hindu
...
1ZLassen has in the text swaripam the MSS. but one have sarupam
...
give imperfect information of things which le within
...
In this way we rise from the knowledge of
...
matter, Prakriti. He does not refer the existence of souls
to one supreme spiritual Being, as the theistic school of
Patanjalit Herein he differs, too, from the Vedantists,
...
down in the beginning. The words sat-karyam express
...
effectum tod dvros.” Professor Wilson remarks, “It is
...
sat] and some other fact which preceded it.”1 So cause
‘is defined, but more precisely, in the Tarka Sangraha:
“That which invariably precedes an effect that cannot
else be is a cause.” It is this law of succession which
...
The last argument of Kapila is “from the natwre of
cause,” or, as Vachaspati explains it, “the identity of
cause and effect.”1 This would have been more properly
...
emanation.? Effect is a developed cause and cause is an
undeveloped effect; both are the same in substance, and


1Sir W. Hamilton also declares
...
It is not universal or pervading (vyapi): each of these
principles (¢attwa) is not found in every form.
...
It is indiscriminating, objective,
...
philosophy which plays an important part in its physical
...
the word by kriyd (act, operation),
and connects it with each of the
foregoing terms (Wilson, p. 51).
...
avarice, and ignorance (S. Chandrika,
Wilson, p. 52).
...
(Buddhi, intellect).” Weare not told
...
2 In the system of Valentinus the
...
brropevovans Tots 5é wddect weraBan-
Advens Tolro aroxeloy Kal Tavrnv
Tov byte Thy apxnvy dacw elvar”
...
Hindti mind, an evil, or at least a defect. The perfect
state is an inactive repose. The third, “ darkness,” is the
erossest of the elements.

The gunas or modes are sometimes termed (1.) Prakasa,
...
activity; this predominates in air. (3.) JJoha, delusion;
...
Each is indiscriminatwve, ic. it has not the power of
...
(ahankara), which presents them to the intellect (uddht).
...
It is generic (sémanya), ue., 1b produces generic or
...
and Gaudapada says that it is so called “ from being the
...
of producing each other, and have a mutual existence, 7.¢.,
...
is the presence of the three modes, and in Distichs 12 and
...
cause, the Unmanifested (Avyakia), which acts (or
...
they possess in their separate nature.2 Development
...
plant, whose seed produces an oil inthe SankhyaPravachana: “Every
used for the cure of scabies (Asiat. assemblage, every combination, has
Res., iv. 310). A Sanskrit name of always for its object another being”
...
qui tend 2 la liberation absolue des
...
pain, &c., belong only to the mind
...
1 The first or teleological argu- in their nature, an appanage; they
ment appears to be of an universal have no raison d’étre except as the
...
or perceived (drigya), and therefore these imply one that
perceives.”1 Each has a separate function, which can
...
it. This pure isolation or abstraction (kaivalya) from
...
1§. Tattwa Kaumudi, Wilson, opposition to the Vedantist doctrine
Oy: that all souls are only portions of the

2 Neither Hindt nor European one, an infinitely extended monad?
commentators explain clearly the Kapila’s argument seems to be that
meaning of this distich; they merely every soul is accompanied by its
...
school Kapila himself seems to have been too honest
...
1 The Vediantist leaning of the of the soul distinguished by per-
Sank. Pravachana shows not only sonality, not of pure soul (which is
that Kapila was not the author of unconditioned).” There is some
the work, but that it is later in time confusion here. In the system of
than the Sank. Karika. Kapila the vital airs belong to the
...
ascetic is lonely and unconcerned while the villagers
...
22. “From Nature (Prakriti) issues the great
principle (mahat, intellect), and from this the Ego
...
4. The five subtle elements (Tanmiatra).

5. The five grosser elements, ether, air, earth, licht
or fire, and water.
...
1 Quoted in Gaudapada’s Comm. matted hair worn by Siva and
...
The word by which buddha (intellect) is defined or
explained is unfortunately of doubtful meaning. In the
Amara Kosha it is a synonym of utsaha, strenuous effort.t
...
“ Lintelligence, c’est la determination distincte des choses,”
...
with our active life to buddhi, the first emanation of
Prakyiti (Nature), as its primary seat. When it is under
the influence of that mode or constituent of Nature called
“goodness,” it is (1.) virtue (dharma), (2.) knowledge
...
also of the Puranas, and of logic, theology, and law.
Internal knowledge is the knowledge of Nature (Prakritt)
...
1 Gaudapada gives this attribute supernatural power to the soul in
...
(ahankara) is abhimaina. The ordinary meaning of this
word is “pride.”* As Vachaspati interprets it, “The
...
“ matter ” in its subtler forms. St.
Hilaire has, incorrectly, “ élément
primitif.”

® Taijasa, having the nature of the
tejas, or active mode.

4 The ordinary sense of both words
(ahankara and abhimana) is pride.
The principle is therefore something
more in Hindi metaphysics than
mere consciousness. “It might be
...
of abhimana from a native scholiast :
* Abhimana est persuasio hominis in
...
giving of activity or impetus is its especial office.
...
this is Lassen’s reading.


2 Colebrooke adopts the reading
bahyabhedascha and translates the
...
(buddht), because they receive sensations which are
...
word by which its proper function is defined (sankal-°
paka) is explained in an uncertain manner by the


tion of Vachaspati and Gaudapada, as tothe reading. As the distich is
Lassen has bahyabhedachcha (bhedat) devoted to an explanation of the
and translates the line thus ; “‘Mul- manas, I prefer, of the two, Lassen’s
tifidum est (the manas) propter interpretation and the reading on
diversam per qualitates mutationem which it is founded, but have given
et propter divisionem per res exter- a slightly different version.
...
indefinite sensations of the different organs of sense.


1 Colebrooke renders the passage
thus; ‘It (the manas) ponders, and
...
The multifariousness mentioned in Distich 27, is often’
...
internal organs is affirmed, ze, their functions in the
...
very intelligible, but as vydna is connected in the S$.
...
arteries being under the action of udana.s
...
organs, which are due to the agency of the mode called
“ooodness,” 2.¢., matter of an etherealised and animate
kind.

The action of the internal organs and sensation may be
either instantaneous, like a flash of lightning, or gradual;
“as,” says Gaudapada, “a person going along a road sees
...
1 This is Professor Wilson’s trans- comes discriminative.” The manas
lation of the passage. I venture to does not reflect; it only forms a
...
but act upon each other by a mutual impulse (¢huta 3).


It sees and understands ~
...
(bhitani), which are called ‘specific.’ They are
...
40. “The subtle (body) liiga, formed primevally,
...
or rudimental body called linga, which forms a curious
element in the Sankhya philosophy. It is a kind of
“ spiritual ” body formed from “intellect” (buddhi),
...
1 “Tet us begin by supposing that some way stored up in that organ
we possess a frame, or the rudiments so as to produce what may be termed
...
Hence it has dispositions or forms of being (bhdvas),
as virtue and other faculties or powers. As the S.
...
It is affirmed in Distich 41 that the litiga cannot
...
1 Nirasrayam, without a receptacle,
i.e. the linga-sarira. The support
...
x. 18, 11, and x. 14, 7-II) properly,
...
may be combined in various degrees.
...
(1.) The transcendental state (saisiddhika), obtained only
...
7. That of the Prajapatis, the abode of the Pitris, or
...
i Bondage ! is the union of the soul with matter, though the
matter may be only the subtle body of the divga, and the
...
has three degrees: (1.) The bondage
...
to the movements of the spiritualised body, which is no
...
48. “There are eight divisions of obscurity, and
...
Incapacity (asakti) arises from the imperfection of the
...
Patanjali defines them as ignorance, self-love, love, hatred,
...
Illusion is defined to be the error which induces men
...
pada, the eight sources of super- profound grief, such as might be
...
the soul, which will then exist in a state wholly
...
Tt is due to Patafijali, the author or expounder of the
...
interpretation is preferable, for the diiga, though formed
...
old age and death until the liga has ceased to be ;
wherefore pain is from the nature of the (liiga).”
...
from Brahma to a stock, from Brahma
...
even that of its subtle vehicle the lizga. It is from
...
fortuitous concourse of atoms only? Kapila does not
...
the stage ceases to dance, so does Nature (Prakriti)
...
It is certainly wrong. The true from the gaze of the soul.
...
or which migrates, .¢., it is not liberated or bound in and
...
| 1 St. Hilaire’s translation is ‘Et be reunited, according to Kapila,

} bien que union de tous deux puisse when the soul has been liberated

subsister encore,” &c. This is in- from it. An assertion or theory of
...
within buddhi, and the latter is absorbed again into
Prakriti.
...
ambiguous. St. Hilaire, “La vertu
et les autres facultés cessent aussitot
d’étre des causes.”
...
7o. “This supreme purifying doctrine the sage
...
has been compendiously written in Aryé metre by
...
1 Sthitt is here, I think, the German dasein, coming into formal being
...
world is only maya, or illusion, was not held by him;
...
to work. We may reason either a priori from cause
...
know whether Kapila admitted what is called sruti, or
...
(avyakta) ; eternal, and, in its essence, unalterable. All
...
their source. They affirmed, as Kapila, that this was not
one of the gross elements, as fire or water, but an invisible,
universal, and formless substance (dvépatov eidos Te nal
...
But they maintained either that
...
3 Plato, Timzeus: “This mother and
receptacle of all visible and sensible
...
theory corresponds to the ahajkara
...
Kapila supposed ahaikara to be
...
consciousness or perception (egotism);
...
and gross forms of matter emanate,
...
« Ex nihilo nihil fit” was an axiom in Hindt philosophy
...
only a passive state, and to the limga, which is formed
...
(page 130), “that subtle body (the liviga) is subject to
...
conditions of the livga or spiritual body, as it may be
...
“ooodness,” “foulness,” and “darkness,” are only the
...
thesoulcan knownothing higherthan,
...
Of all the changes which I have
...
enable them to reach. It was practically opposed to
...
yoga, 2.e., the concentration of the soul on the Supreme
Being by abstract meditation as the means of obtaining
finally Nirvana, or absorption into the Divine Essence.1
Hence this system is called the Sefwara or Theistical
Sankhya, and Kapila’s the Mir7swara or Atheistical; a
...
the Hindt mythology), himself infinite, unlimited by

1 Jn the full attainment of yoga, are either wholly overcome and


or a mystic union with the Deity, destroyed, or they act only as far
...
pious meditation. The aim of the Yogz or devotee under
...
u Yoga-Sastra, i. 23, 24, 26-29; Colebrooke, i. 264.
...
forth a very sublime aim, has resulted in the p
cruel and degrading rites, of almost incredible devi
self-torture, which have no high or purifying p
but, on the contrary, often conceal a base ant
sensual life. The Yogi is frequently regarded as a |
sorcerer, and in this character he appears in man
...
THESE systems are generally classed together, for they
...
the laws of thought. The Vaiseshika system is a system
of physical science as taught by Kanada, the reputed
author of the Vaiseshika-Sutra, in which this system is
...
(udde§a) ; (2.) definition (lakshana) ; and (3.) investigation
(partksha@). Enunciation declares by name the subject to
be discussed. Definition is the defining of the subject by
its peculiar properties or differentiz. Investigation is an
...
Proof or evidence (pramaéna) is of four kinds: (1.)
...
of sense; (5.) intellect (buddht); (6.) mind (manas) ; (7.)
production, oral, mental, or corporeal; (8.) fault or wrong
(dosha); (g.) transmigration; (10.) fruit or retribution ;
...
The Supreme Soul (Paramdtman) is One, the seat of
...
generality or community of properties, particularity or
...
(3.) Whatever is produced is non-eternal, as pots, &c.
(4.) Sound is produced,
...
there is in the subject of the question (paksha) an attribute
...
The system of Kanada (the Vazseshika) is supplementary
...
(apas); (3.) light (tejas); (4.) air (wayn); (5.) ether
(akaSa); (6.) time (kala); (7.) space (dif); (8.) soul
(dtman); and (9.) the internal organ, mind (manas). Of
...
example, is formed by the aggregation of luminous atoms. _
...
Iéwara= God, as ruler, is not found in the Saras ascribed
...
earth must have had a Maker,” says Hariddsa, “ because
it is an effect, like a jar.’1 This is the argument which
...
down from father to son, which, it is argued, must have
...
qualities, but of an infinitely higher kind. Kanada
certainly taught that the soul is distinct from matter.
...
In the second category, “quality,” Kanada recognised
seventeen varieties in the nine substances, of which
...
eround. It affects earth and water. Lightness is not a
...
The fourth category, community (sémanya), is the source
...
The fifth category, particularity (visesha), denotes simple
...
privation (abhava), is of two kinds, universal and mutual.
...
Gotama and Kanada, like Kapila, could see no hi
aim or blessing for mankind than a complete deliy
from pain. They agree with him in maintaining that th
deliverance must be wrought out by knowledge, m
ing thereby a knowledge of philosophy, and that
state to which the soul may rise by knowledge, its
...
\
 ...
 oodness,” and therefore as being more subtle product
than even the subtle elements of what are usually


as an organ of sight belongs to this last class. It is form
entirely of gross matter. It seems then that Kapila m
by “‘intellect-organs” something of a very different nature


elements. The faculty by which we see was connected
Kapila directly with Consciousness, and by it a sense-pere
...
“§. Tattwa Kaumudi,” for he supposes that by “non-specific ”
...
through the buddhi to Soul, is an inquiry that we may lay
aside as haying no practical importance.
...
NOTE B.
ON THE MEANING oF Sat AND Asal.
...
entity sprang from nonentity [asat].’ In the Atharva-Veda
...
Skambha.’ The Taittiriya Upanishad also (p. 99) quotes a
verse to the effect: ‘This was at first nonentity. From that
And in a note he adds: “This phrase
...
even beyond, and instead of the sat or ré Gy, they postulated
an asat, ré 7 Gv, as the beginning of all things. Thus we
read in the Chandogya Upanishad, ‘And some say in the
beginning there was asat (not being) alone, without a second ;
and from this asat might the sat be born’” (Sans, Literature,

p. 324). There is occasionally some confusion in the minds
of Hindi writers, especially the later ones, about the meaning
of sat and asat; but, with Kapila and his exponents, sat
...
nonentity (asat) nor entity (sat) ; for mind was, as it were,
neither entity nor nonentity.
mind is neither the primal matter (Prakriti) (which Kapila
assumed to be the source of all formal existence), nor the sum
of existing things. The Vedantists taught that this primal
matter was the gakti, or productive energy of Brahma. So
...
tial; for without it the creative action of the Supreme Deity
could not be accomplished, since if he were destitute of his
Sakti, any activity on his part would be inconceivable” (Comm,
on the Brahma Sitras, Muir’s Sans. Texts, iii. 164). The
full development of the Vedantist doctrine made the external
world to be only mdyd, illusion. There is really neither sat
nor asat, but the Supreme Spirit is absolutely the All. Nature
...
God is not a person, but personality itself, i.e, the universal
personality which realises itself in every human consciousness
as so many separate thoughts of one eternal mind. . . . God
is with him the whole process of thought, combining in itself
the objective movement as seen in Nature, with the subjective
...
aggregate of existing things and each separate existence (sdf),
...
Veda who explain asaé as meaning “an undeveloped state,”
...
things have been developed. Sat was the whole of existent
things. In Rig-Veda, i. 96, 7, Agni is called satas gopa, the
guardian of that which has a present being. There is also en
...
“ Desire, then, in the beginning (agré) arose in It, which was
...
ON THE CONNECTION OF THE SANKHYA SYSTEM WITH
...
calling the one Natura naturans and the other Natura naturata.
God is the cause of all things, not of their existence merely,
but of their essence, and this not transiently but immanently.
God is the only substance, whether as Natura naturans or
Natura naturata. Whatever is, is in God, and without God
...
Spinoza taught that truth, 2.c., the just correlation of idea
and fact, might be obtained. Ideas are obtained (1.) by the
action of the bodily senses; (2.) in their generic form by
imagination, #.¢., the remembrance of sensational ideas, which
...
we have a near approach to the Vedantist doctrine of maya
...
“Deum esse non tantum causam, ut res incipiant existere, §
...
either system. Man seeks only his own advantage, though
...
ON THE CONNECTION OF THE System or KAPILA WITH THAT
...
conscious life. Its hain are chiefly a mere abserions c


Ghai many cares, ras with eth toil ; and abu
thoroughly Hinda sentiment—is itself an evil. Love brin,
upon us embarrassments and disappointment; it require
immense sacrifices; it causes more pain than pleasure ;
...
continual sacrifice. The end, if gained, is not a compensation _
for the substantial evils of the method of our success; and
our intellectual eleyation makes us only more sensitive of
...
made miserable by pain, which comes upon mankind from
three different sources. In the Sutras attributed to him it
...
source of all formal existence, the Uy of the Greeks. ‘The
...
absorbed and lost init. In its primary state it was in a con-—
...
Hartmann represents the Unconscious as the unity of Willand
...
Kapila the external world is presented to the soul by Buddlu
...
world in anything that belongs to our present life. It has its
root in consciousness, which is found in every kind of formal
existence, even the lowest, but has its highest development in
...
with all the miseries of this, will be for ever exhausted and
...
Hartmann, too, asserts a true Nirvana, the extinction of all
...
(un ocean d’ivresse) would flow into it;, an inexhaustible
...
1 Dialogues Philosophiques, trois. dial. (Réves), pp. 125-128.
