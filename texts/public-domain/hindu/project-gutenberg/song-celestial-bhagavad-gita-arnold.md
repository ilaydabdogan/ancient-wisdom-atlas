---
id: hindu.bhagavad_gita.arnold_song_celestial_gutenberg
...
date_range: classical Sanskrit devotional-philosophical poem (c. 2nd century BCE-2nd
  century CE); 1885 public-domain English verse translation
source_type: text
provenance:
  source_id: source.project_gutenberg.2388
  edition: 'Project Gutenberg plain-text eBook #2388; Edwin Arnold, The Song Celestial,
    or Bhagavad-Gîtâ, first published London 1885'
...
rights:
  ...
  full_text: allowed
  notes: Project Gutenberg catalog records public-domain status in the USA; Arnold's
    1885 translation is long out of copyright. Use outside the USA requires jurisdiction-specific
    review.
trademark:
  status: present
  marks:
