---
id: sanskrit.vishnu_sahasranama.itrans_gutenberg
...
tradition: hindu
culture: sanskrit_devotional_recitation_original_language
region: india
source_language: Sanskrit
text_language: Sanskrit
date_range: from the Mahabharata (Anushasana Parva), compiled c. 400 BCE-400 CE
source_type: text
provenance:
  source_id: source.project_gutenberg.9000
  edition: 'Project Gutenberg plain-text eBook #9000, romanized (ITRANS transliteration)
    Sanskrit text of the full stotra'
  translator: ''
  editor: N. Srinivasan and Karthik Krishnan (transcription)
  publication_year: 2003
  publisher: Project Gutenberg
  source_url: https://www.gutenberg.org/ebooks/9000
...
rights:
  ...
  full_text: allowed
  notes: 'original-language extraction program: translator-effect control. Ancient
    Sanskrit text, public domain; romanized ITRANS scheme rather than Devanagari.
    Queued as the only clean Sanskrit-language text on PG: no PD-clean digital Sanskrit
    Bhagavad Gita was found this expedition (archive.org candidates are post-1929
    editions or Devanagari scans with unusable OCR) - Gita in Sanskrit remains an
    open target (try GRETIL/sanskritdocuments.org provenance next).'
trademark:
  status: present
  marks:
  - Project Gutenberg
