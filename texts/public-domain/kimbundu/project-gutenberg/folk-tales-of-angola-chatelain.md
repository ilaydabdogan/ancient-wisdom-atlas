---
id: african.folk_tales_angola.chatelain_archive
title: 'Folk-Tales of Angola: Fifty Tales, with Ki-mbundu Text, Literal English Translation,
...
tradition: kimbundu
culture: kimbundu_oral_narrative_verbatim_bilingual
region: west_central_africa_angola
source_language: Kimbundu
text_language: English
date_range: living oral tradition; recorded and published 1894
source_type: folktale_collection
provenance:
  source_id: source.internet_archive.folktalesofangol00chat
  edition: Internet Archive full-text OCR (_djvu.txt) of the 1894 American Folk-Lore
    Society edition (Memoirs vol. 1)
  translator: Heli Chatelain
  editor: Heli Chatelain
  publication_year: 1894
  publisher: Internet Archive
  source_url: https://archive.org/details/folktalesofangol00chat
...
rights:
  ...
  full_text: allowed
  notes: Published 1894, US public domain. High scientific value - this is a rare
    VERBATIM bilingual field record with parallel Kimbundu text and literal English
    translation of fifty tales as narrated by native tellers, not a colonial paraphrase.
    Chatelain worked directly from dictation; introduction and notes carry 19th-century
    framing that should not be extracted as Kimbundu self-description, but the tale
    texts themselves are primary.
trademark:
  status: present
  marks:
  - Project Gutenberg
