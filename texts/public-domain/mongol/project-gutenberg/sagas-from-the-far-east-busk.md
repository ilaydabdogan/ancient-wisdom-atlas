---
id: mongol.sagas_from_the_far_east.busk_gutenberg
title: Sagas from the Far East
alternate_titles:
- Kalmouk and Mongolian Traditionary Tales
- Sagas from the Far East - Siddhi-Kur
text_status: complete
tradition: mongol
culture: kalmyk_and_mongolian_folk_tale_later_translation
region: central_asia_steppe
source_language: Kalmyk
text_language: English
date_range: Kalmyk/Mongolian tale-cycle (the Siddhi-Kur / Ardji-Bordji); 1873 public-domain
  English rendering
source_type: text
provenance:
  source_id: source.project_gutenberg.40402
  edition: 'Project Gutenberg plain-text eBook #40402; [Rachel Harriette Busk], Sagas
    from the Far East; or, Kalmouk and Mongolian Traditionary Tales (Griffith and
    Farran, London, 1873)'
  translator: Rachel Harriette Busk
  editor: ''
  publication_year: 1873
  publisher: Project Gutenberg
  source_url: https://www.gutenberg.org/ebooks/40402
...
rights:
  ...
  full_text: allowed
  notes: Project Gutenberg catalog records public-domain status in the USA. English
    rendering (via German of Jülg) of the Kalmyk Siddhi-Kur and Ardji-Bordji tale
    cycles; a verbatim retelling with the author's notes, not a scholarly critical
    text.
trademark:
  status: present
  marks:
